...
\begin{figure}[h] % 'h' indica que la figura debe colocarse aquí
    ...
    \includegraphics[width=0.5\textwidth]{1.png} % Cambia '1.png' por el nombre de tu imagen
...
\begin{figure}[h] % 'h' indica que la figura debe colocarse aquí
    \centering % Centra la imagen
    \includegraphics[width=0.5\textwidth]{1234.png} % Cambia '1.png' por el nombre de tu imagen
    \caption{Descripción de la imagen.} % Título de la figura
    \label{fig:mi_imagen} % Etiqueta para referenciar la figura
\end{figure}
